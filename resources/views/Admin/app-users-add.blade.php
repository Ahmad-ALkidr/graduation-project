...
@section('content')
    ...
    <!-- Content -->
        <div class="app-ecommerce" style="margin: 40px;">
            <!-- Add User -->
            <form action="{{route('user.store')}}" class="add-new-user" method="post"
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (f_name.value.trim() === '') {
                    ...
                    f_name.classList.add('is-invalid');
                    document.getElementById('add-f_name-error').textContent = 'First Name must be at least 5 characters.';
                    isValid = false;
                }
