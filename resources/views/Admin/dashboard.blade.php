        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <small class="d-block mb-1 text-muted">Content</small>
                        </div>
                        <h4 class="card-title mb-1">Total Posts</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex gap-2 align-items-center mb-2">
                                    <span class="badge bg-label-info p-1 rounded">
                                        <i class="ti ti-message-dots ti-xs"></i>
                                    </span>
                                    <p class="mb-0">Posts</p>
                                </div>
                                <h5 class="mb-0 pt-1 text-nowrap">{{ $postCount }}</h5>
                                <small class="text-muted">Total posts on the platform</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
                <div class="card">
                    ...
                    <div id="revenueGenerated"></div> <!-- This can be a small chart if you add one -->
                </div>
            </div>
            <!--/ Total Comments -->
